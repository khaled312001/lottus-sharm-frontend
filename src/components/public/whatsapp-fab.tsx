...
export function WhatsAppFAB({ phone }: { phone: string }) {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 end-6 z-40 flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3.5 text-white shadow-2xl shadow-[#25D366]/40"
    >
      ...
      <span className="hidden md:inline text-sm font-bold relative">WhatsApp</span>
    </motion.a>
  );
}
