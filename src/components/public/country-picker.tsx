...
export function CountryPicker({
  ...
  const ph = placeholder || (L(locale, {
    ar: 'اختر الجنسية',
    en: 'Select nationality', de: 'Nationalität wählen',
          ...
          >
            ...
            <div className="flex items-center justify-between gap-2 px-4 py-3 border-b border-accent/15 bg-gradient-to-br from-primary to-primary-900 text-cream">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-sm">
                  {L(locale, { ar: 'اختر الجنسية', en: 'Select nationality', de: 'Nationalität wählen', ru: 'Гражданство', it: 'Nazionalità' })}
                </h3>
              </div>
              <button
                type="button"
            ...
            <div className="relative border-b border-accent/15 px-4 py-3">
              ...
              <input
                ...
                placeholder={L(locale, { ar: 'ابحث عن دولة...', en: 'Search country...', de: 'Land suchen ...', ru: 'Поиск страны...', it: 'Cerca paese...' }) as string}
            ...
            {popular.length > 0 && (
              <div className="px-4 pt-3">
                <div className="text-[10px] uppercase tracking-[0.2em] font-bold text-muted-foreground mb-2">
                  {L(locale, { ar: 'الأكثر اختياراً', en: 'Popular', de: 'Beliebt', ru: 'Популярные', it: 'Più scelti' })}
                </div>
            ...
            <div className="px-4 py-2.5 border-t border-accent/15 bg-muted/20 text-[11px] text-muted-foreground flex items-center justify-between">
              <span>
                {filtered.length} {L(locale, { ar: 'دولة', en: 'countries', de: 'Länder', ru: 'стран', it: 'paesi' })}
              </span>
